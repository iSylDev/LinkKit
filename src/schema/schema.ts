...
export const NewBookmarkSchema = z.object({
  title: z
    .string()
    .min(2, { message: "Title cannot be less than 2 chars" })
    .max(30, { message: "Title cannot be greater than 30 chars" }),
  description: z
    .string()
    .min(0)
    .max(100, { message: "description cannot be greater than 100 chars" }),
